...
static void versal_help(FILE *fp)
{
	fprintf(fp,
			...
			"\t-p  mode <32b/128b> type <fixed/incr> <address> <file> [tr_mode <slow/fast>] [sbi <y/n>]   Download the specified File (.pdi) at given address\n"
			...
			"\t    \tsbi          - optional y/n download target specifier (Default: y)\n"
